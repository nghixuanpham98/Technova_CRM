...
function initializePagination(paginationId, totalPages, visiblePages, pageIndexId, onPageCallback) {
...
function clearPagination(elm) {
    if ($('#' + elm).data("twbs-pagination")) {
